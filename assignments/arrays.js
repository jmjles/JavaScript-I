...
let sortedModels = carModels.sort();
let htmlModels=[];
for(let i = 0; i < 5;i++){
  htmlModels.push(sortedModels[i])
}
document.getElementById('aChallenge3').innerHTML = htmlModels.toString().replace(/,/g,'<br/>') +"<br/> (The rest is in console log)";
...
let htmlYears=[];
for(let i = 0; i < 5;i++){
  htmlYears.push(carYears[i])
}
document.getElementById('aChallenge4').innerHTML = htmlYears.toString().replace(/,/g, "<br/>") + "<br/> (The rest is in console log)";
...
for (let i = 0; i < BMWAndAudi.length; i++){
  list.push(
    BMWAndAudi[i].car_year,
    BMWAndAudi[i].car_model,
    BMWAndAudi[i].car_make,
    '<br/>'
    )
}
document.getElementById('aChallenge6').innerHTML = list.toString().replace(/,/g, " ")
